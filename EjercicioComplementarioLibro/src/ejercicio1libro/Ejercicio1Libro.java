...
Necesitas modelar la clase "Libro" con los siguientes requisitos:
...
Crea un método para establecer el número de páginas, teniendo en cuenta que este 
número surge del cálculo entre un número ingresado por el usuario multiplicado por 7.
Ej: Si el usuario ingresa 20, la cantidad de páginas que tendrá ese libro es 140 (7*20).
Además, la clase debe tener un método público llamado "imprimirDetalles" que 
imprime por consola todos los detalles del libro, incluyendo el título, el autor y el número de páginas.
